...
void ImageFormatConvert::NV21ToJpg(QStringList paths, int Height, int Width, int Stride)
{
    for(int i = 0;i<paths.size();i++)
    {
        std::string path = paths[i].toStdString();
...
//tobe modify
void ImageFormatConvert::I420ToJpg(QStringList paths, int Height, int Width, int Stride)
{
    for(int i = 0;i<paths.size();i++)
    {
        std::string path = paths[i].toStdString();
